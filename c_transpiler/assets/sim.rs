...
(get_string_signal,"getStringSignal",(signal_name:String)->Option<Vec<u8>>),
...
(add_particle_object,"addParticleObject",(object_type:i64,size:f64,density:f64,params:Vec<f64>,life_time:f64,max_item_count:i64),opt(color:Vec<f64>)->i64),
(add_particle_object_item,"addParticleObjectItem",(object_handle:i64,item_data:Vec<f64>)->()),
(add_referenced_handle,"addReferencedHandle",(object_handle:i64,referenced_handle:i64)->()),
...
(align_shape_bb,"alignShapeBB",(shape_handle:i64,pose:Vec<f64>)->i64),
...
(create_shape,"createShape",(options:i64,shading_angle:f64,vertices:Vec<f64>,indices:Vec<i64>,normals:Vec<f64>,texture_coordinates:Vec<f64>,texture:Vec<u8>,texture_resolution:Vec<i64>)->i64),
...
(get_is_real_time_simulation,"getIsRealTimeSimulation"->i64),
...
(get_matrix_inverse,"getMatrixInverse",(matrix:Vec<f64>)->Vec<f64>),
...
(get_named_bool_param,"getNamedBoolParam",(name:String)->bool),
(get_named_float_param,"getNamedFloatParam",(name:String)->f64),
(get_named_int32_param,"getNamedInt32Param",(name:String)->i64),
...
(get_object_alias_relative,"getObjectAliasRelative",(handle:i64,base_handle:i64),opt(options:i64)->String),
...
(get_object_float_array_param,"getObjectFloatArrayParam",(object_handle:i64,parameter_id:i64)->Vec<f64>),
...
(get_object_sel,"getObjectSel"->Vec<i64>),
...
(get_pose_inverse,"getPoseInverse",(pose:Vec<f64>)->Vec<f64>),
...
(get_script_functions,"getScriptFunctions",(script_handle:i64)->serde_json::Value),
...
(get_setting_bool,"getSettingBool",(key:String)->bool),
(get_setting_float,"getSettingFloat",(key:String)->f64),
(get_setting_int32,"getSettingInt32",(key:String)->i64),
(get_setting_string,"getSettingString",(key:String)->String),
...
(get_vision_sensor_res,"getVisionSensorRes",(sensor_handle:i64)->()),
...
(handle_embedded_scripts,"handleEmbeddedScripts",(call_type:i64)->i64),
...
(interpolate_poses,"interpolatePoses",(pose_in1:Vec<f64>,pose_in2:Vec<f64>,interpol_factor:f64)->Vec<f64>),
...
(matrix_to_pose,"matrixToPose",(matrix:Vec<f64>)->Vec<f64>),
...
(multiply_poses,"multiplyPoses",(pose_in1:Vec<f64>,pose_in2:Vec<f64>)->Vec<f64>),
...
(pose_to_matrix,"poseToMatrix",(pose:Vec<f64>)->Vec<f64>),
...
(read_custom_data_block_ex,"readCustomDataBlockEx",(handle:i64,tag_name:String),opt(options:serde_json::Value)->()),
(read_custom_data_block_tags,"readCustomDataBlockTags",(object_handle:i64)->Vec<String>),
(read_custom_table_data,"readCustomTableData",(handle:i64,tag_name:String),opt(options:serde_json::Value)->()),
...
(relocate_shape_frame,"relocateShapeFrame",(shape_handle:i64,pose:Vec<f64>)->i64),
...
(remove_referenced_objects,"removeReferencedObjects",(object_handle:i64)->()),
...
(set_joint_target_position,"setJointTargetPosition",(object_handle:i64,target_position:f64),opt(motion_params:Vec<f64>)->()),
(set_joint_target_velocity,"setJointTargetVelocity",(object_handle:i64,target_velocity:f64),opt(motion_params:Vec<f64>)->()),
...
(set_named_bool_param,"setNamedBoolParam",(name:String,value:bool)->()),
(set_named_float_param,"setNamedFloatParam",(name:String,value:f64)->()),
(set_named_int32_param,"setNamedInt32Param",(name:String,value:i64)->()),
...
(set_object_float_array_param,"setObjectFloatArrayParam",(object_handle:i64,parameter_id:i64,params:Vec<f64>)->()),
...
(set_object_sel,"setObjectSel",(object_handles:Vec<i64>)->()),
...
(visit_tree,"visitTree",(root_handle:i64,visitor_func:String),opt(options:serde_json::Value)->()),
...
(write_custom_data_block_ex,"writeCustomDataBlockEx",(handle:i64,tag_name:String,data:String),opt(options:serde_json::Value)->()),
(write_custom_table_data,"writeCustomTableData",(handle:i64,tag_name:String,the_table:serde_json::Value),opt(options:serde_json::Value)->()),
